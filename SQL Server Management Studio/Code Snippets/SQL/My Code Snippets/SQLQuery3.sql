...
begin
	...
	specalist_contact varchar (50) not null
	);
	...
	species_order int not null constraint fk_orderid foreign key references tbl_order(order_id) on update cascade on delete cascade,
	...
	('care_5','move subhect to exercise pen',3),
	...
	('icy aquarium with snowy fascade',50000),
	('short grass, shade and moat',50000),
	('netted forest atrium',10000),
	('jungle vines and winding branches',15000),
	('cliff wigh shaded cave',15000)
	;
	select * from tbl_habitat;

	insert into tbl_specialist
	(specialist_fname,specialist_lname,specalist_contact)
	values
	('margaret','nguyen','384-576-2889'),
	('mary','fischer','384-784-48556'),
	('arnold','holden','385-475-3944'),
	('margaret','nguyn','384-485-4855'),
	('margaret','nguyn','768-288-3749')
	;
	...
	('ghost bat',1,102,3,5007,2204,'care_2'),
	...
	/*The following queries database uning inner joins*/
	select 
	...
	select 
	a1.species_name,a5.habitat_type,a5.habitat_cost,
	a6.nutrition_type,a6.nutrition_cost
	from tbl_species a1
	inner join tbl_animalia a2 on a2.animalia_id=a1.species_animalia
	inner join tbl_class a3 on a3.class_id=a1.species_class
	inner join tbl_order a4 on a4.order_id=a1.species_order
